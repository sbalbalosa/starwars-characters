...
export type CharactersQuery = { __typename?: 'Root', allPeople: { __typename?: 'PeopleConnection', people: Array<{ __typename?: 'Person', id: string, name: string | null, gender: string | null, eyeColor: string | null, hairColor: string | null, filmConnection: { __typename?: 'PersonFilmsConnection', films: Array<{ __typename?: 'Film', id: string, title: string | null } | null> | null } | null } | null> | null } | null };
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    films: build.query<FilmsQuery, FilmsQueryVariables | void>({
      query: (variables) => ({ document: FilmsDocument, variables })
    }),
...
export const { useFilmsQuery, useLazyFilmsQuery, useCharactersQuery, useLazyCharactersQuery } = injectedRtkApi;
